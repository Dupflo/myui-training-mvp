export default ({ env }) => ({
  "users-permissions": {
    config: {
      register: {
        allowedFields: ['lastname', 'firstname', 'temp_password']
      },
    }
  },
  "video-field": {
  ...
  email: {
    config: {
      ...
      settings: {
        defaultSenderEmail: env('BREVO_SENDER'),
        defaultSenderName: "MYUI Training",
  ...
  'icons-field': {
    ...
    config: {
      icons: [
        {
          name: 'Livre',
          svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/></svg>'
        },
        {
          name: 'Haltère',
